package io.github.kaducmk.comprinhas.list.presentation
...
import io.github.kaducmk.comprinhas.list.presentation.components.bottom_sheet.BottomBar
import io.github.kaducmk.comprinhas.list.presentation.components.ListTopBar
import io.github.kaducmk.comprinhas.list.presentation.components.ShoppingList
import io.github.kaducmk.comprinhas.list.presentation.dialogs.NewItemDialog
    ...
    ComprinhasTheme {
        ShoppingListScreen(
            ...
            uiState = ShoppingListUiState.Loading(
                currentUser = null,
                io.github.kaducmk.comprinhas.home.data.model.ShoppingList(
                    id = "1",
                    nome = "Daiso",
                    senha = "",
                    criador = Usuario(
